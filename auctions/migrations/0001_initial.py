# Generated by Django 4.1.3 on 2022-12-20 21:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listong_bid', to='auctions.bid')),
                ...
                ('watch', models.ManyToManyField(blank=True, null=True, related_name='watch', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
